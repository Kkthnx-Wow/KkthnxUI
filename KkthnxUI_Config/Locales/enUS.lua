...
L_GUI_GENERAL_REPLACE_BLIZZARD_FONTS = "Replaces the default |cff00B4FFBlizzard fonts|r on various panels and frames from |cff71d5ffKkthnxUI|r."
...
L_GUI_RESET_ALL = "Are you sure you want to reset all settings for |cff71d5ffKkthnxUI|r."
...
L_GUI_UNITFRAME_ENABLE = "Use |cff71d5ffKkthnxUI|r Player, Target & Focus layout."
