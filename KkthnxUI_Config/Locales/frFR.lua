...
_G.KkthnxUIConfig["frFR"] = {
	...
	["GroupNames"] = {
		...
		["Boss"] = BOSS,
		["Chat"] = CHAT,
		["DataBars"] = "Barresdedonnées",
		["DataText"] = "Textededonnées",
		["Filger"] = "Filger",
		["General"] = GENERAL,
		["HealthPrediction"] = "Prédictiondesanté",
		["Inventory"] = INVENTORY_TOOLTIP,
		["Loot"] = LOOT,
		["Minimap"] = MINIMAP_LABEL,
		["MinimapButtons"] = "BoutonsdeMinimap",
		["Misc"] = MISCELLANEOUS,
