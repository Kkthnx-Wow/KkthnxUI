...
UIConfigLocal.AnnouncementsBadGear = "副本中檢查錯誤裝備"
...
UIConfigLocal.AnnouncementsSayThanks = "對某些法術表示感謝"
UIConfigLocal.AnnouncementsSpells = "釋放某些法術時通知隊友"
UIConfigLocal.AnnouncementsSpellsFromAll = "檢查所有隊友的法術釋放情況"
...
UIConfigLocal.BlizzardClassColor = "好友列表、查詢列表、公會成員列表中玩家名稱職業顏色"
UIConfigLocal.BlizzardColorTextures = "更改大多數UI材質色調顏色"
UIConfigLocal.BlizzardHideTalkingHead = "隱藏NPC語音消息框"
...
-- Chat
UIConfigLocal.ChatBackground = "開啟聊天背景"
...
UIConfigLocal.GeneralTranslateMessage = "彈出GUI幫助信息"
...
UIConfigLocal.MiscAlreadyKnown = "已學習的圖紙及已收集的坐騎和寵物上色"
UIConfigLocal.MiscArmory = "人物右鍵菜單中加入英雄榜鏈接（可能使菜單崩潰）"
...
UIConfigLocal.MiscEnhancedMail = "壹鍵收郵件"
...
UIConfigLocal.NameplatesClassIcons = "PvP中顯示職業圖標"
UIConfigLocal.NameplatesCombat = "進戰鬥自動顯示姓名板"
...
UIConfigLocal.NameplatesSpiral = "增益螺旋計時"
UIConfigLocal.NameplatesTimer = "增益數字計時"
...
-- PulseCD
UIConfigLocal.PulseCD = "冷卻提示"
UIConfigLocal.PulseCDAnimationScale = "自動縮放"
UIConfigLocal.PulseCDEnable = "顯示冷卻提示"
UIConfigLocal.PulseCDHoldTime = "最大留存時間"
UIConfigLocal.PulseCDSize = "圖標大小"
UIConfigLocal.PulseCDSound = "報警聲音"
UIConfigLocal.PulseCDThreshold = "最小觸發時間"

-- RaidCD
UIConfigLocal.RaidCD = "團隊冷卻"
UIConfigLocal.RaidCDEnable = "啟用團隊冷卻"
UIConfigLocal.RaidCDHeight = "冷卻計時條高度"
UIConfigLocal.RaidCDWidth = "冷卻計時條高度（如果顯示圖標，高度+28）"
UIConfigLocal.RaidCDUpWards = "冷卻計時條向上堆疊"
UIConfigLocal.RaidCDExpiration = "根據剩余時間排序"
UIConfigLocal.RaidCDShowSelf = "顯示自身冷卻計時"
UIConfigLocal.RaidCDShowIcon = "顯示圖標"
UIConfigLocal.RaidCDShowInRaid = "在團隊副本中顯示計時條"
UIConfigLocal.RaidCDShowInParty = "在五人副本中顯示計時條"
UIConfigLocal.RaidCDShowInArena = "在競技場中顯示計時條"
...
UIConfigLocal.TooltipHyperLink = "鏈接上顯示鼠標提示"
UIConfigLocal.TooltipInstanceLock = "鼠標提示中顯示地下城鎖定狀態"
...
UIConfigLocal.UnitframeClassColor = "生命條職業顏色"
...
UIConfigLocal.UnitframeIconPlayer = "玩家施法條圖標顯示在左側或右側"
UIConfigLocal.UnitframeIconTarget = "目標施法條圖標顯示在左側或右側"
...
UIConfigLocal.UnitframeSwingBar = "顯示普通攻擊計時條"
...
UIConfigLocal.RaidframeAuraWatchTimers = "減益圖標上顯示計時"
...
UIConfigLocal.RaidframeHorizontalHealthBars = "生命條水平顯示"
UIConfigLocal.RaidframeIconSize = "減益圖標大小"
UIConfigLocal.RaidframeIndicatorSize = "邊角指示器尺寸"
UIConfigLocal.RaidframeMainTankFrames = "團隊中顯示主坦克/助手框體"
UIConfigLocal.RaidframeManabarHorizontal = "法力條水平顯示"
UIConfigLocal.RaidframeManabarShow = "顯示法力條"
UIConfigLocal.RaidframeMaxUnitPerColumn = "每列顯示多少單位"
UIConfigLocal.RaidframePvPDebuffs = "PvP DeBuffs圖示"
...
UIConfigLocal.WorldMapFogOfWar = "移除戰爭迷霧"
