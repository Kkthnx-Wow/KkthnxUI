...
L_GUI_ACTIONBAR_HOTKEY = "Показывать бинды на кнопках"
...
L_GUI_MINIMAP_COLLECTBUTTONS = "Скомпоновать кнопки некоторых аддонов на миникарте"
...
L_GUI_MINIMAP_GARRISON = "Показывать иконку гарнизона на миникарте"
...
L_GUI_MISC_SELLMISC = "Автоматически продавать ненужные предметы качеством отличным от серого"
...
-- Nameplates
L_GUI_NAMEPLATES_AD_HEIGHT = "Дополнительная высота для выбранного индикатора"
L_GUI_NAMEPLATES_AD_WIDTH = "Дополнительная ширина для выбранного индикатора"
...
L_GUI_NAMEPLATES_NAME_ABBREV = "Сокращать имена длиннее 18 знаков"
...
L_GUI_UNITFRAME_STYLE = "Стиль рамок 'Жирный или Нормальный'"
