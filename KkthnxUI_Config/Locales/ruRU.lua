...
UIConfigLocal.ChatFilter = "Удалять некоторый спам игроков в чате"
...
UIConfigLocal.ChatSpam = "Удалить спам некоторых системных сообщений ('Игрок1' побеждает в поединке 'Игрок2')"
...
UIConfigLocal.DataTextLocation = "Включить название локации вверху миникарты"
...
UIConfigLocal.MiscErrors = "Фильтровать сообщения об ошибках интерфейса."
...
UIConfigLocal.UnitframeClassPortraits = "Включить старые портреты классов"
UIConfigLocal.UnitframeCombatText = "Показывать текст боя"
UIConfigLocal.UnitframeEnable = "Включить рамки юнитов"
UIConfigLocal.UnitframeFlatClassPortraits = "Включить новые портреты классов"
UIConfigLocal.UnitframeFocusCastbarHeight = "Высота полосы заклинаний фокуса"
UIConfigLocal.UnitframeFocusCastbarWidth = "Ширина полосы заклинаний фокуса"
