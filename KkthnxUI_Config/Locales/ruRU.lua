...
L_GUI_ACTIONBAR_PETBAR_HORIZONTAL = "Использовать горизонтальную панель питомца"
L_GUI_ACTIONBAR_PETBAR_MOUSEOVER = "Панель питомца по наведению мыши (только для горизонтальной панели)"
...
L_GUI_ANNOUNCEMENTS_SAY_SAPPED = "Мгновенно оповещать об ошеломлении, когда |cFFFFF569Разбойник|r напал на вас"
...
L_GUI_BLIZZARD_CLASS_COLOR = "Окрашивать имена игроков по классам в окне друзей, гильдии и т.д."
...
L_GUI_BLIZZARD_VEHICLE_MOUSEOVER = "Фрейм транспорта по наведению мыши"
-- Plugins
L_GUI_DATABARS = "Панель Данных"
L_GUI_DATABARS_ARTIFACT_COLOR = "Цвет полосы артефакта"
L_GUI_DATABARS_ARTIFACT_ENABLE = "Включить полосу артефакта"
...
L_GUI_DATABARS_HONOR_ENABLE = "Включить полосу чести"
...
L_GUI_AURAS_HIDE_BUFFS = "Скрыть отображение баффов"
L_GUI_AURAS_HIDE_DEBUFFS = "Скрыть отображение дебаффов"
-- GUI Buttons
...
L_GUI_DATATEXT_SYSTEM = "Включить отображение FPS и пинга под миникартой"
L_GUI_DATATEXT_TIME = "Включить отображение часов внизу миникарты"
L_GUI_DATATEXT_TIME24HR = "Установить 24-часовой формат времени"
-- Cooldown
