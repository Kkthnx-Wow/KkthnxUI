...
UIConfigLocal.DataTextBottomBar = "动作条下方开启数据信息条"
UIConfigLocal.DataTextLocalTime = "显示本机时间"
UIConfigLocal.DataTextSystem = "小地图下方显示帧数和延时"
UIConfigLocal.DataTextThreatBar = "下方数据信息条显示仇恨条"
...
-- Cooldown
UIConfigLocal.Cooldown = "Cooldown冷却"
...
UIConfigLocal.NameplatesDistance = "S在此范围内显示姓名板"
...
UIConfigLocal.PulseCDThreshold = "最小出发时间"
