...
function Bags:CreateReagentContainer()
	...
	SwitchBankButton.Text:SetShadowOffset(K.Mult, K.Scale(-3)) -- Temp
	...
	SortButton.Text:SetShadowOffset(K.Mult, K.Scale(-3)) -- Temp
...
function Bags:CreateContainer(storagetype, ...)
	...
	if (storagetype == "Bag") then
		...
		Sort.Text:SetShadowOffset(K.Mult, K.Scale(-3)) -- Temp
		...
		SwitchReagentButton.Text:SetShadowOffset(K.Mult, K.Scale(-3)) -- Temp
