...
-- 		CharacterFrameInset:SetPoint("BOTTOMRIGHT", CharacterFrame, "BOTTOMLEFT", insetOffset, 4)

-- 		CharacterFrameInset.Bg:SetTexture(texturePath)
-- 		CharacterFrameInset.Bg:SetTexCoord(0, isExpanded and 0.935547 or 1, 0, 1)
-- 		CharacterFrameInset.Bg:SetHorizTile(isExpanded)
-- 		CharacterFrameInset.Bg:SetVertTile(isExpanded)
-- 	end
...
-- 	hooksecurefunc(CharacterFrame, "Collapse", function(self)
