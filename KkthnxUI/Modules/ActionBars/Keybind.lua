...
function Module:Bind_CreateDialog()
	...
	frame.text:SetFont(select(1, KkthnxUIFont:GetFont()), 12)
	...
	button1.text:SetFont(select(1, KkthnxUIFont:GetFont()), 12)
	...
	button2.text:SetFont(select(1, KkthnxUIFont:GetFont()), 12)
