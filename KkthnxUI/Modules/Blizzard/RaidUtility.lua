...
K.RaidUtility = Module.RaidUtility
...
local function ButtonEnter(self)
	self:SetBackdropBorderColor(RAID_CLASS_COLORS[K.Class].r, RAID_CLASS_COLORS[K.Class].g, RAID_CLASS_COLORS[K.Class].b, 1)
	self:SetBackdropColor(RAID_CLASS_COLORS[K.Class].r * .15, RAID_CLASS_COLORS[K.Class].g * .15, RAID_CLASS_COLORS[K.Class].b * .15, C["Media"].BackdropColor[4])
end
...
function Module:OnInitialize()
	...
	-- Close Button
	self:CreateUtilButton("RaidUtility_CloseButton", RaidUtilityPanel, "UIMenuButtonStretchTemplate, SecureHandlerClickTemplate", 136, 18, "TOP", RaidUtilityPanel, "BOTTOM", 0, -6, CLOSE, nil)
	...
	RoleIcons:SetPoint("LEFT", RaidUtilityPanel, "RIGHT", 0, 0)
	...
	for i, role in ipairs(roles) do
		...
		texture:SetTexture(337499) --(337499)
	...
	-- Disband Raid button
	self:CreateUtilButton("DisbandRaidButton", RaidUtilityPanel, "UIMenuButtonStretchTemplate", RaidUtilityPanel:GetWidth() * 0.8, 18, "TOP", RaidUtilityPanel, "TOP", 0, -6, "Disband Group", nil)
	...
	-- Raid Control Panel
	self:CreateUtilButton("RaidControlButton", RaidUtilityPanel, "UIMenuButtonStretchTemplate", RoleCheckButton:GetWidth(), 18, "TOPLEFT", ReadyCheckButton, "BOTTOMLEFT", 0, -6, "Raid Menu", nil)
	...
	if CompactRaidFrameManager then
		...
		CompactRaidFrameManagerDisplayFrameLeaderOptionsRaidWorldMarkerButton:SetWidth(RoleCheckButton:GetWidth() * 0.21)
