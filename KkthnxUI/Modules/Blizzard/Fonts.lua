...
KkthnxUIFonts:SetScript("OnEvent", function(self, event)
	...
	SetFont(GameTooltipHeader, NORMAL, 13, nil, nil, nil, nil, 0, 0, 0, 1, -1)
	...
	SetFont(QuestFont_Super_Huge, NORMAL, 22, nil, nil, nil, nil, 0, 0, 0, 1, -1)
	...
	SetFont(SystemFont_OutlineThick_WTF, NORMAL, 31, "OUTLINE", nil, nil, nil, 0, 0, 0, 1, -1)
	SetFont(SystemFont_Shadow_Huge1, NORMAL, 20, "OUTLINE")
	SetFont(SystemFont_Shadow_Huge3, NORMAL, 25)
	SetFont(SystemFont_Shadow_Large_Outline, NORMAL, 17, "OUTLINE")
	SetFont(SystemFont_Shadow_Large, NORMAL, 17)
	SetFont(SystemFont_Shadow_Large2, NORMAL, 19)
