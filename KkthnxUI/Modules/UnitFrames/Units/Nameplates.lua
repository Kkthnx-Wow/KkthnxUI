...
function Module:AddTargetIndicator(self)
	...
	self.TargetIndicator.TopArrow:SetTexture(C["MediaMisc"].NPArrow)
	...
	self.TargetIndicator.RightArrow:SetTexture(C["MediaMisc"].NPArrow)
	...
	self.TargetIndicator.Glow:SetBackdrop({edgeFile = C["MediaSettings"].Glow, edgeSize = 4})
...
function Module:CreateGCDTicker(self)
	...
	spark:SetTexture(C["MediaMisc"].Spark_16)
