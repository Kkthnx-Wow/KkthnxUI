...
function Module:CreateHealthPrediction()
	...
	myBar:SetStatusBarColor(0, 0.827, 0.765, 0.6)
	...
	otherBar:SetStatusBarColor(0.0, 0.631, 0.557, 0.6)
	...
	absorbBar:SetStatusBarColor(0.85, 0.85, 0.9, 0.6)
	...
	healAbsorbBar:SetStatusBarColor(0.9, 0.1, 0.3, 0.6)
	...
	if overHealAbsorb then
		...
		overHealAbsorb:SetSize(10, Health:GetHeight())
	end
	overHealAbsorb:Hide()
