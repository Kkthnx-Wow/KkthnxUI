...
function Module:CreateAFKCam()
	...
	AFKMode.chat:SetFontObject(_G.KkthnxUIFont)
	...
	AFKMode.top.time:SetFontObject(_G.KkthnxUIFont)
	...
	AFKMode.top.date:SetFontObject(_G.KkthnxUIFont)
	...
	AFKMode.bottom.name:SetFontObject(_G.KkthnxUIFont)
	...
	AFKMode.bottom.playerInfo:SetFontObject(_G.KkthnxUIFont)
	...
	AFKMode.bottom.guild:SetFontObject(_G.KkthnxUIFont)
	...
	AFKMode.statMsg.info:SetFontObject(_G.KkthnxUIFont)
	...
	AFKMode.countd.text:SetFontObject(_G.KkthnxUIFont)
