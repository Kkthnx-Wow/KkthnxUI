...
function WorldMap:CreateCoords()
	...
	self.Coords:FontString("PlayerText", C.Media.Font, C.Media.Font_Size, C.Media.Font_Style)
	self.Coords:FontString("MouseText", C.Media.Font, C.Media.Font_Size, C.Media.Font_Style)
