...
C["Media"] = {
	...
	["Statusbars"] = {
		...
		Glamour7Statusbar = [[Interface\AddOns\KkthnxUI\Media\Textures\Glamour7.tga]],
		...
		KuiBrightStatusbar = [[Interface\AddOns\KkthnxUI\Media\Textures\KuiStatusbarBright.tga]],
		KuiStatusbar = [[Interface\AddOns\KkthnxUI\Media\Textures\KuiStatusbar.tga]],
		...
		WGlassStatusbar = [[Interface\AddOns\KkthnxUI\Media\Textures\Wglass.tga]],
