...
local function _Dialog_OnShow(dialog)
	...
	_G.PlaySound(PlaySoundKitID and "IgMainMenuOpen" or SOUNDKIT.IG_MAINMENU_OPEN)
...
local function _Dialog_OnHide(dialog)
	_G.PlaySound(PlaySoundKitID and "IgMainMenuClose" or SOUNDKIT.IG_MAINMENU_CLOSE)
...
local function _BuildDialog(delegate, data)
	...
	if not dialog then
		...
		close_button:SetPoint("TOPRIGHT", -4, -4)
		close_button:Hide()
