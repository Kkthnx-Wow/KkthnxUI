...
local list = {
	...
	["Target Aura"] = {
		...
		{ AuraID = 270332, UnitID = "target", Caster = "player", Flash = true },
		...
		{ AuraID = 375893, UnitID = "target", Caster = "player" },
	},
	["Special Aura"] = {
		...
		{ AuraID = 363805, UnitID = "player", Flash = true },
	},
	["Focus Aura"] = {
