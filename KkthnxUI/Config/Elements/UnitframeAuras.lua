...
C.DebuffsTracking_Blacklist = {
	...
	spells = {
		...
		[195776] = Priority(), -- Moonfeather Fever
		[206150] = Priority(), -- Challenger's Burden SL
		[206151] = Priority(), -- Challenger's Burden BfA
		...
		[313015] = Priority(), -- Recently Failed (Mechagnome racial)
		[322695] = Priority(), -- Drained
		[328891] = Priority(), -- A Gilded Perspective
		[348443] = Priority(), -- Experience Eliminated
		[234143] = Priority(), -- Temptation (Upper Karazhan Ring Debuff)
		[392960] = Priority(), -- Waygate Travel
	},
}
