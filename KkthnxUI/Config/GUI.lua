...
local ActionBar = function(self)
	...
	Window:CreateSwitch("ActionBar", "MicroBarMouseover", L["Enable MicroBarMouseover"])
...
local Inventory = function(self)
	...
	Window:CreateSwitch("Inventory", "FilterMount", L["Filter Mount Items"], nil, UpdateBagStatus)
...
local DataBars = function(self)
	...
	Window:CreateColorSelection("DataBars", "AzeriteColor", L["Azerite Bar Color"])
...
local Minimap = function(self)
	...
	Window:CreateSwitch("Minimap", "ShowGarrison", L["Show Garrison Button"])
...
local Unitframe = function(self)
	...
	Window:CreateSwitch("Unitframe", "Castbars", enableTextColor..L["Enable Castbars"])
	...
	Window:CreateSwitch("Unitframe", "GlobalCooldown", L["Show Global Cooldown"])
	Window:CreateSwitch("Unitframe", "OnlyShowPlayerDebuff", L["Only Show Your Debuffs"])
	Window:CreateSwitch("Unitframe", "PortraitTimers", L["Portrait Spell Timers"])
...
local Party = function(self)
	...
	Window:CreateSwitch("Party", "PortraitTimers", L["Portrait Spell Timers"])
...
local Raid = function(self)
	...
	Window:CreateSwitch("Raid", "AuraDebuffs", L["AuraWatch"])
	Window:CreateSwitch("Raid", "AuraWatch", L["Show AuraWatch Icons"])
	...
	Window:CreateSlider("Raid", "AuraDebuffIconSize", L["Aura Debuff Icon Size"], 18, 30, 1)
	Window:CreateSlider("Raid", "AuraWatchIconSize", L["AuraWatch Icon Size"], 8, 14, 1)
...
local WorldMap = function(self)
	...
	Window:CreateSwitch("WorldMap", "MapReveal", L["Show Zones You Have Yet to Discover"])
	Window:CreateSwitch("WorldMap", "MapRevealGlow", L["Show Map Reveal Overlay Shadow"])
