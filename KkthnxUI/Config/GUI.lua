...
local Unitframe = function(self)
	...
	Window:CreateSlider("Unitframe", "PlayerFrameHeight", newFeatureIcon .. L["Player Frame Height"], 10, 75, 1)
	...
	Window:CreateSlider("Unitframe", "TargetFrameHeight", newFeatureIcon .. L["Target Frame Height"], 10, 75, 1)
