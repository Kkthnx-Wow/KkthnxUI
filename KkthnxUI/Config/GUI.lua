...
local Nameplate = function(self)
	...
	Window:CreateSwitch("Nameplate", "ShowPlayerPlate", "Show Personal Resource")
...
local Unitframe = function(self)
	...
	Window:CreateSwitch("Unitframe", "TargetOfTargetLevel", "Show ToT Level")
	Window:CreateSwitch("Unitframe", "TargetOfTargetName", "Show ToT Name")
