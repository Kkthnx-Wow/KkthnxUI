...
local ActionBar = function(self)
	...
	Window:CreateSwitch("ActionBar", "Enable", "|cff00cc4c".."Enable ActionBar")
...
local Automation = function(self)
	...
	Window:CreateSwitch("Automation", "AutoAcceptSummon", "Auto Accept Summon Requests")
	...
	Window:CreateInput("Automation", "WhisperInvite", "Auto Accept Invite Keyword")
end
...
local Chat = function(self)
	...
	Window:CreateSwitch("Chat", "EnableFilter", "Enable Chat Filter")
	...
	Window:CreateInput("Chat", "ChatFilterList", "ChatFilter BlackList", "Enter words you want blacklisted|n|nUse SPACES between each word|n|nPress enter when you are done", K:GetModule("Chat"):UpdateFilterList())
	Window:CreateInput("Chat", "ChatFilterWhiteList", "ChatFilter WhiteList", "Enter words you want whitelisted|n|nUse SPACES between each word|n|nPress enter when you are done", K:GetModule("Chat"):UpdateFilterWhiteList())
...
local DataBars = function(self)
	...
	Window:CreateSlider("DataBars", "Width", "DataBars Width", 20, 220, 1)
...
local General = function(self)
	...
	Window:CreateSwitch("General", "DisableTutorialButtons", "Disable Tutorial Buttons")
...
local Loot = function(self)
	...
	Window:CreateSwitch("Loot", "GroupLoot", "|cff00cc4c".."Enable Group Loot")
	...
	Window:CreateSwitch("Loot", "OnlyLootQuestItems", "Only Loot Quest Items", "This will only loot Quest Items and Money! Nothing else will be looted unless you loot it manually. |n|n|CFF669DFFThis requires|r 'Auto Loot' |CFF669DFFto be turned off!|r")
end
...
local Minimap = function(self)
	...
	Window:CreateSlider("Minimap", "Size", "Minimap Size", 120, 220, 1)
end
...
local Nameplate = function(self)
	...
	Window:CreateSwitch("Nameplate", "MaxPowerGlow", "Fully Charged Power Glow")
	...
	Window:CreateSwitch("Nameplate", "PPPowerText", "Show PlayerPlate Power Value")
	Window:CreateSwitch("Nameplate", "QuestIndicator", "Quest Progress Indicator")
	Window:CreateSwitch("Nameplate", "ShowPlayerPlate", "Show Pensonal Resource")
...
local Tooltip = function(self)
	...
	Window:CreateSwitch("Tooltip", "HideRealm", "how realm name by SHIFT")
...
local Unitframe = function(self)
	...
	Window:CreateSwitch("Unitframe", "Castbars", "|cff00cc4c".."Enable Castbars")
	...
	Window:CreateSwitch("Unitframe", "Enable", "|cff00cc4c".."Enable Unitframes")
	...
	Window:CreateSwitch("Unitframe", "CombatText", "|cff00cc4c".."Enable Simple CombatText")
