...
local ActionBar = function(self)
	...
	Window:CreateSwitch("ActionBar", "FadeBottomBar1", L["Mouseover BottomBar 1"])
	Window:CreateSwitch("ActionBar", "FadeBottomBar2", L["Mouseover BottomBar 2"])
...
local General = function(self)
	...
	Window:CreateSection("General Fading")
	Window:CreateSlider("General", "GlobalFade", L["Alpha Of Mouseover Elements"], 0, 1, 0.1)
...
local Unitframe = function(self)
	...
	Window:CreateSlider("Unitframe", "PlayerFrameHeight", newFeatureIcon .. L["Player Frame Height"], 30, 75, 1)
	Window:CreateSlider("Unitframe", "PlayerFrameWidth", newFeatureIcon .. L["Player Frame Width"], 120, 200, 1)
	...
	Window:CreateSlider("Unitframe", "TargetFrameHeight", newFeatureIcon .. L["Target Frame Height"], 30, 75, 1)
	Window:CreateSlider("Unitframe", "TargetFrameWidth", newFeatureIcon .. L["Target Frame Width"], 120, 200, 1)
