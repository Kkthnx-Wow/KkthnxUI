...
local Unitframe = function(self)
	...
	Window:CreateSlider("Unitframe", "PlayerFrameHeight", "Player Frame Height", 30, 75, 1)
	Window:CreateSlider("Unitframe", "PlayerFrameWidth", "Player Frame Width", 120, 200, 1)
	...
	Window:CreateSlider("Unitframe", "TargetFrameHeight", "Target Frame Height", 30, 75, 1)
	Window:CreateSlider("Unitframe", "TargetFrameWidth", "Target Frame Width", 120, 200, 1)
