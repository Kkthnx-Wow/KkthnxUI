...
local ActionBar = function(self)
	...
	Window:CreateSlider("ActionBar", "CustomBarButtonSize", "Set CustomBar Button Size", 24, 60, 1, nil, UpdateCustomBar)
	Window:CreateSlider("ActionBar", "CustomBarNumButtons", "Set CustomBar Num Buttons", 1, 12, 1, nil, UpdateCustomBar)
	Window:CreateSlider("ActionBar", "CustomBarNumPerRow", "Set CustomBar Num PerRow", 1, 12, 1, nil, UpdateCustomBar)
...
local Automation = function(self)
	...
	Window:CreateSwitch("Automation", "AutoSkipCinematic", "Auto Skip All Cinematic/Movies")
...
local Chat = function(self)
	...
	Window:CreateSlider("Chat", "Width", "Chat Width", 300, 600, 1, nil, UpdateChatSize)
	Window:CreateSlider("Chat", "Height", "Chat Height", 150, 300, 1, nil, UpdateChatSize)
...
local General = function(self)
	...
	if C["General"].ReplaceBlizzardFonts then
		Window:CreateSlider("General", "FontSize", "Adjust 'Some' Font Sizes", 10, 16, 1, nil, UpdateFontSizes)
	end
...
local Misc = function(self)
	...
	Window:CreateSwitch("Misc", "EasyMarking", "EasyMarking by Ctrl + LeftClick")
...
local Nameplate = function(self)
	...
	Window:CreateSlider("Nameplate", "ExecuteRatio", "Unit Execute Ratio", 0, 90, 1, L["ExecuteRatioTip"])
...
local Skins = function(self)
	...
	Window:CreateSlider("Skins", "ChatBubbleAlpha", "ChatBubbles Background Alpha", 0, 1, 0.1, nil, UpdateChatBubble)
end
...
local Unitframe = function(self)
	...
	Window:CreateSlider("Unitframe", "TargetBuffsPerRow", "Number of Buffs Per Row", 4, 10, 1, nil, UpdateTargetBuffs)
	Window:CreateSlider("Unitframe", "TargetDebuffsPerRow", "Number of Debuffs Per Row", 4, 10, 1, nil, UpdateTargetDebuffs)
