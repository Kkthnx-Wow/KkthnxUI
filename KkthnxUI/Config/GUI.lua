...
local Unitframe = function(self)
	...
	Window:CreateSlider("Unitframe", "PlayerFrameHeight", L["Player Frame Height"], 30, 75, 1)
	Window:CreateSlider("Unitframe", "PlayerFrameWidth", L["Player Frame Width"], 120, 200, 1)
	...
	Window:CreateSlider("Unitframe", "TargetFrameHeight", L["Target Frame Height"], 30, 75, 1)
	Window:CreateSlider("Unitframe", "TargetFrameWidth", L["Target Frame Width"], 120, 200, 1)
