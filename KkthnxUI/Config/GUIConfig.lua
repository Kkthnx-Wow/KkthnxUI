...
local function CreateAuraWatchCategory()
	local auraWatchCategory = GUI:AddCategory(L["AuraWatch"] or "AuraWatch", "Interface\\Icons\\Ability_deathknight_heartstopaura")
...
local function CreateAutomationCategory()
	...
	-- GUI:CreateSwitch(miscSection, "Automation.AutoKeystoneStart", L["Auto Keystone Start"], L["AutoKeystoneStart Desc"])
	-- GUI:CreateSwitch(miscSection, "Automation.AutoKeystoneStartAnnouncements", L["Announce Keystone Countdown"], L["AutoKeystoneStartAnnounce Desc"])
