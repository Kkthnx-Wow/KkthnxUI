...
do
	...
	K.AboutPanel:SetScript("OnShow", function(self)
		...
		buttonGitHub:SetScript("OnClick", function()
			K.StaticPopup_Show("GITHUB_EDITBOX", nil, nil, "https://github.com/Kkthnx-Wow/KkthnxUI")
		end)
		...
		buttonBugReport:SetScript("OnClick", function()
			K.StaticPopup_Show("GITHUB_EDITBOX", nil, nil, "https://github.com/Kkthnx-Wow/KkthnxUI/issues/new")
		end)
		...
		buttonDiscord:SetScript("OnClick", function()
			K.StaticPopup_Show("GITHUB_EDITBOX", nil, nil, "https://discord.gg/YUmxqQm")
		end)
