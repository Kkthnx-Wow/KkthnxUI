...
L["AddOnData"] = {
	...
	SkinnerText = "|cffffff00".."Skinner profile loaded".."|r",
	SkinnerNotText = "|CFFFF0000AddOn Skinner is not loaded!|r",
}
...
L["Automation"] = {
	...
	Subzone_Grand_Bazaar = "Le Grand bazar",
	Subzone_Port_of_Zandalar = "Port de Zandalar",
}
