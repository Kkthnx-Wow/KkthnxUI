...
L.DataBars = {
	...
	HonorRightClick = "|cffcccccc鼠标右键：PVP天赋面板|r"
}

-- DataText Localization
L.DataText = {
	ArmError = "不能获得“战斗的召唤”信息",
	AvoidAnceShort = "Avd: ",
	Bags = "包裹",
	Bandwidth = "带宽:",
	BasesAssaulted = "已袭击基地:",
	BasesDefended = "已保卫基地:",
	CartsControlled = "被控制矿车:",
	CombatTime = "战斗/竞技场计时",
	Coords = "坐标",
	DemolishersDestroyed = "摧毁工程车:",
	Download = "下载:",
	FlagsCaptured = "已获得旗帜:",
	FlagsReturned = "已归还旗帜:",
	FPS = "帧数",
	GatesDestroyed = "已攻破大门:",
	GoldDeficit = "亏损:",
	GoldEarned = "获得:",
	GoldProfit = "利润:",
	GoldServer = "服务器:",
	GoldSpent = "花费:",
	GoldTotal = "总计:",
	GraveyardsAssaulted = "已攻陷墓地:",
	GraveyardsDefended = "已防御墓地:",
	GuildNoGuild = "无公会",
	LootSpecChange = "|cffFFFFFF鼠标右键:|r 更改拾取专精|r",
	LootSpecShow = "|cffFFFFFFShift+鼠标左键:|r 显示专精天赋|r",
	LootSpecSpec = "拾取专精",
	LootSpecTalent = "|cffFFFFFF鼠标左键:|r 更改专精天赋|r",
	Memory = "内存",
	MicroMenu = "微型菜单",
	MS = "毫秒",
	NoDungeonArm = "没有任何副本激活了“战斗的召唤”加成",
	NoOrderHallUnlock = "您还没有开启职业大厅",
	NoOrderHallWO = "职业大厅+",
	OrbPossessions = "拥有宝珠:",
	OrderHall = "职业大厅",
	OrderHallReport = "鼠标左键:打开职业大厅报告",
	SavedDungeons = "已锁定地下城",
	SavedRaids = "已锁定团队副本",
	System = "系统状态:",
	Time = "时间",
	TotalBagSlots = "背包总空间",
	TotalFreeBagSlots = "空余背包格子",
	TotalMemory = "已使用总内存:",
	TotalMemoryUsage = "已使用总内存",
	TotalUsedBagSlots = "已使用包裹空间",
	TowersAssaulted = "已攻陷防御塔:",
	TowersDefended = "已防守防御塔:",
	VictoryPoints = "胜利点数:",
	Slots = {
...
L.Popup = {
	...
	ResetDataText = "您确定您想重置所有信息条设置至默认吗？",
