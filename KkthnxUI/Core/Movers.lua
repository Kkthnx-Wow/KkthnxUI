...
function Movers:CreateDragInfo()
	...
	self.DragInfo:SetScript("OnEnter", function(self) self:SetBackdropColor(K.Color.r, K.Color.g, K.Color.b, 0.8) end)
	self.DragInfo:SetScript("OnLeave", function(self) self:SetBackdropColor(60/255, 155/255, 237/255, 0.4) end)
