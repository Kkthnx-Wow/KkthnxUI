...
function Profiles:Enable()
	...
	self.Description:SetFontObject(_G.KkthnxUIFont)
	...
	self.Status:SetFontObject(_G.KkthnxUIFont)
	...
	self.Apply.Text:SetFontObject(_G.KkthnxUIFont)
	...
	self.Reset.Text:SetFontObject(_G.KkthnxUIFont)
