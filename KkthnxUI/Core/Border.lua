...
function K.CreateBorder(object, offset, size, path)
	...
	topRight:SetDrawLayer("OVERLAY", 2)
	...
	bottomLeft:SetDrawLayer("OVERLAY", 2)
	...
	bottomRight:SetDrawLayer("OVERLAY", 2)
