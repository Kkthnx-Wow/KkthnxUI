...
stds.wow = {
	read_globals = {
		...
		"SetPortraitTexture", "time", "GetInventoryItemCooldown", "FlashClientIcon",
		"CreateAndInitFromMixin", "IconDataProviderMixin", "IconDataProviderExtraType",
		"RegisterUnitWatch", "UnregisterUnitWatch",
		"UnitIsGroupLeader", "UnitIsGroupAssistant", "SetRaidTarget", "SetRaidTargetIconTexture",
		"InitiateRolePoll", "C_PartyInfo", "READY_CHECK", "ROLE_POLL", "CANCEL", "TANK", "HEALER", "DAMAGER",
		"UninviteUnit", "CONVERT_TO_RAID", "TEAM_DISBAND",
