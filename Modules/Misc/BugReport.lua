...
local function CreateField(parent, label, hint, multiline, height)
	...
	if hint then
		...
		ghost:SetTextColor(K.Colors.disabled[1], K.Colors.disabled[2], K.Colors.disabled[3])
		ghost:SetText(hint)
...
function Module:BuildReport()
	...
	sub:SetTextColor(K.Colors.muted[1], K.Colors.muted[2], K.Colors.muted[3])
	...
	out:SetTextColor(K.Colors.offWhite[1], K.Colors.offWhite[2], K.Colors.offWhite[3])
	out:SetWidth(458)
	out:SetHeight(120)
	...
	outHint:SetTextColor(K.Colors.disabled[1], K.Colors.disabled[2], K.Colors.disabled[3])
